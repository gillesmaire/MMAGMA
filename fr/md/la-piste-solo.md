...
pistes que nous verrons dans la partie [Création des grooves](Partie-III-Création-des-Grooves).
...
- Les réglages des pistes Solo ne sont pas sauvegardés ni récupérables via la commande 
   Groove. 
- Un certain nombre de réglages sont donc nécessaires pour cette piste, 
...
La chanson court générée par ChordV donne le résultat automatique suivant :
